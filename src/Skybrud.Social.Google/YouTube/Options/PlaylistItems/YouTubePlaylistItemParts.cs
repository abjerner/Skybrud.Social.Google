namespace Skybrud.Social.Google.YouTube.Options.PlaylistItems {
    ...
    public class YouTubePlaylistItemParts {
        ...
        /// <summary>
        /// Indicates that the response from the YouTube API should include the <code>snippet</code> object of the playlist items.
        /// </summary>
        public static readonly YouTubePlaylistItemPart Snippet = new YouTubePlaylistItemPart("snippet");
        
        /// <summary>
        /// Indicates that the response from the YouTube API should include the <code>contentDetails</code> object of the playlist items.
        /// </summary>
        public static readonly YouTubePlaylistItemPart ContentDetails = new YouTubePlaylistItemPart("contentDetails");
        
        /// <summary>
        /// Indicates that the response from the YouTube API should include the <code>status</code> object of the playlist items.
        /// </summary>
